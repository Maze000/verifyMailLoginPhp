     ...
     <?php
      ...
      if(isset($_GET['mail']) AND isset($_GET['hash'])){
          ...
          if($match > 0){
              ...
              echo "Your account has been activated, you can now <a style='font-weight:bold;color:#2BA6CB;' target='_blank' href='https://marionettegames.000webhostapp.com/verifyCorrection2/login.php'> Login </a>";
          }else{
